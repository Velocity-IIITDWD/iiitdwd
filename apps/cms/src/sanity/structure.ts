          ...
          S.list()
            ...
            .items([
                  ...
                  S.list()
                    ...
                    .items([
                      S.listItem()
                        ...
                        .schemaType('contact')
                        .child(S.documentTypeList('contact').title('Contact Persons')),
                      S.listItem()
                        .title('Contact Categories')
                        .schemaType('contactCategory')
                        .child(S.documentTypeList('contactCategory').title('Contact Categories')),
                      S.listItem()
                        .title('Contact Data')
                        .schemaType('contactData')
                        .child(S.documentTypeList('contactData').title('Contact Data')),
                    ])
                ),
              S.listItem()
                .title("KRC")
                  ...
                  S.list()
                    ...
                    .items([
                      S.listItem()
                        ...
                        .schemaType("krcData")
                        .child(
                          S.documentTypeList("krcData").title("KRC Data")
                        ),
                      S.listItem()
                        .title("Krc Data TEL(First three)")
                        .schemaType("krcDataTel")
                        .child(S.documentTypeList("krcDataTel").title("Krc Data TEL(First three)")
                        ),
                      S.listItem()
                        .title("KRC Data TEL(Full)")
                        .schemaType("krcDataTelFull")
                        .child(S.documentTypeList("krcDataTelFull").title("KRC Data TEL(Full)")
                        ),
                    ])
                ),
              S.listItem()
              ...
              S.listItem()
                .title('Tenders')
                .schemaType('tender')
                .child(S.documentTypeList('tender').title('Tenders & Procurement')),
              S.listItem()
          ...
          S.list()
            ...
            .items([
              S.listItem()
                ...
                .child(S.documentTypeList('seatStructure').title('Seat Structure')),
              S.listItem()
                .title('Description Structure')
                .schemaType('descriptionStructure')
                .child(S.documentTypeList('descriptionStructure').title('Description Structure')),
              S.listItem()
          ...
          S.list()
            ...
            .items([
              ...
              S.listItem()
                ...
                .child(S.documentTypeList('boardOfGovernor').title('Board of Governors')),
              S.listItem()
                .title('The Senate')
                .schemaType('senate')
              ...
              S.listItem()
                ...
                .schemaType('finance')
                .child(S.documentTypeList('finance').title('Finance Committee')),
              S.listItem()
                .title('Building & Working Committee')
                .schemaType('buildingAndWorks')
                .child(S.documentTypeList('buildingAndWorks').title('Building & Working Committee')),
              S.listItem()
                .title('Staff')
                .schemaType('staff')
          ...
          S.list()
            ...
            .items([
              ...
              S.listItem()
                ...
                .child(S.documentTypeList('researchProfiles').title('Research Profiles')),
              S.listItem()
                .title('Departments')
                .child(
                  S.list()
              ...
              S.listItem()
                ...
                .child(S.documentTypeList('annualReport').title('Annual Report')), 
            ])
        ),
      S.listItem()
        .title('Home')
          ...
          S.list()
            ...
            .items([
              S.listItem()
                ...
                .child(S.documentTypeList('mainCarouselImage').title('Main Carousel Images')),
              S.listItem()
                .title('Program Cards')
                .schemaType('programCards')
                .child(S.documentTypeList('programCards').title('Program Cards')),
              S.listItem()
                .title('Programs')
          ...
          S.list()
            ...
            .items([
              ...
              S.listItem()
                ...
                .child(S.documentTypeList('student_coordinators').title('Student Coordinators')),
            ])
        ),
    ])