        ...
        <div className="flex flex-col lg:flex-row gap-10 items-center justify-between bg-white/5 border border-white/10 rounded-[2rem] p-6 md:p-10 backdrop-blur-sm shadow-2xl">
          ...
          >
            ...
            <div className="text-gray-300 leading-relaxed text-[16px] md:text-[18px] mb-8 max-w-2xl font-medium space-y-4">
              <p>
                We are proud to announce that our students have advanced to the
                finals of the ISRO Robotics Challenge (IROC) 2026, securing a
                spot among the top 20 teams nationwide.
              </p>
              <p>
                This is a great achievement for the team and reflects the strong
                technical foundation fostered at IIIT Dharwad. Wishing Team
                ICARUS the very best in the final round!
              </p>
            </div>
