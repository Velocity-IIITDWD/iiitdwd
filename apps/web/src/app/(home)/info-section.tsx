...
import TendersUpdatesSection from "./tenders-updates"; // Force recompile
...
export default async function InfoSection(): Promise<JSX.Element> {
  ...
  const convocationMessageLink =
    "https://youtu.be/A8n2L3trKrE?si=OPEcGV1LY2epQkMU";
          ...
          <div className="bg-gradient-to-br from-white via-white to-gray-50 p-6 md:p-12 rounded-[1.5rem] md:rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col lg:flex-row gap-8 md:gap-12 items-center relative overflow-hidden group">
            ...
            <div className="w-full lg:w-[450px] shrink-0 grid grid-cols-2 gap-4 z-10 relative">
              <div className="bg-white/80 backdrop-blur p-6 rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] text-center flex flex-col justify-center items-center group/card hover:border-[#CCE70B]/50 transition-colors relative overflow-hidden">
                ...
                <p className="text-[44px] font-black text-[#193654] mb-1 group-hover/card:scale-110 transition-transform duration-500 drop-shadow-sm">
                  2015
                </p>
              ...
              <div className="bg-[#193654] p-6 rounded-2xl shadow-[0_8px_25px_rgba(25,54,84,0.2)] text-left flex flex-col justify-between relative overflow-hidden group/loc">
                ...
                <div className="relative z-10 mt-auto">
                  ...
                  <p className="text-[13px] font-medium text-[#CCE70B]">
                    Karnataka, India
                  </p>
                </div>
              </div>
              ...
              <div className="col-span-2 bg-white p-6 rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex flex-col justify-between gap-5 group/prog hover:border-[#CCE70B]/50 transition-colors">
                ...
                <div className="flex justify-between items-center gap-3">
                  <Link
                    ...
                    className="flex-1 bg-gray-50 border border-gray-100 hover:border-[#193654] hover:bg-[#193654] hover:text-white text-[#193654] transition-all duration-300 rounded-xl py-3 text-center text-[13px] font-bold shadow-sm hover:shadow-md hover:-translate-y-0.5"
                  >
                    B.Tech
                  </Link>
                  <Link
                    href="/admission/mtech"
                    className="flex-1 bg-gray-50 border border-gray-100 hover:border-[#193654] hover:bg-[#193654] hover:text-white text-[#193654] transition-all duration-300 rounded-xl py-3 text-center text-[13px] font-bold shadow-sm hover:shadow-md hover:-translate-y-0.5"
                  >
                    M.Tech
                  </Link>
            ...
            <div className="bg-white rounded-[1.5rem] md:rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden flex flex-col group hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-300 h-[500px] md:h-[550px] xl:h-[620px] relative hover:-translate-y-1">
              ...
              <div className="p-5 md:p-6 xl:p-5 flex flex-col flex-1 relative overflow-hidden">
                ...
                <div className="inline-flex items-center gap-3 mb-4 xl:mb-3 relative z-10">
                  ...
                  <h3 className="text-[22px] xl:text-[20px] font-black text-[#193654] tracking-tight">
                    Director's Message
                  </h3>
                </div>
                <p className="text-gray-600 leading-relaxed text-[15px] xl:text-[14px] line-clamp-none xl:line-clamp-[7] flex-1 relative z-10 font-medium">
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 flex items-center justify-between relative z-10">
                  <div className="flex gap-3">
                    <a
                      ...
                      className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center hover:bg-[#FF0000] hover:text-white transition-all duration-300 text-gray-400 hover:shadow-md hover:scale-110"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center hover:bg-[#0077B5] hover:text-white transition-all duration-300 text-gray-400 hover:shadow-md hover:scale-110"
                    >
                      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
                  ...
                  <Link
                    href="/director"
                    className="text-[14px] font-bold text-[#193654] hover:text-[#CCE70B] transition-colors flex items-center gap-1.5 group/link"
                  >
                    Read Full Message{" "}
                    <IconArrowUpRight
                      size={18}
            ...
            <div className="flex flex-col gap-6 h-[600px] md:h-[550px] xl:h-[620px]">
              ...
              <div className="bg-white rounded-[1.5rem] md:rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden flex-1 flex flex-col group hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-1">
                <div className="p-5 border-b border-gray-50 flex items-center gap-4 shrink-0 bg-gradient-to-r from-gray-50/50 to-white">
                  ...
                  <h3 className="font-bold text-[#193654] text-[16px] tracking-wide">
                    Convocation Address
                  </h3>
                </div>
                <div className="relative flex-1 bg-black w-full min-h-[180px]">
                  <VideoPlayer
                    externalLink={convocationMessageLink}
                    embedSrc={convocationMessageEmbed}
                    className="!absolute !inset-0 !w-full !h-full !rounded-none border-none !block"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col h-full w-full bg-white relative p-5 md:p-6 xl:p-5">
                ...
                <div className="flex items-center mb-6 border-b border-gray-100 pb-1 shrink-0">
                  <div className="relative pb-4 flex items-center gap-2 text-[#193654]">
                    <IconFileText size={18} className="text-[#CCE70B]" />
                    <span className="text-[16px] xl:text-[14.5px] font-bold tracking-wide whitespace-nowrap">Tenders</span>
